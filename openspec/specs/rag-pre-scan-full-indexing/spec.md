# rag-pre-scan-full-indexing Specification

## Purpose

Verificación e indexación full de la rama antes del análisis LangGraph, con polling bloqueante y port de dominio para estado del índice RAG.
